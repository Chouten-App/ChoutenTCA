...
public struct Module: Hashable, Equatable, Codable, Sendable {
    ...
    public init(id: String, type: String, subtypes: [String], icon: String? = nil, name: String, version: String, formatVersion: Int, updateUrl: String, general: GeneralMetadata) {//, updateStatus: ModuleVersionStatus = .upToDate) {
        self.id = id
        self.type = type
    ...
    public static let sample = Module(
        id: "whatever",
        type: "source",
    ...
    public static let sample2 = Module(
        id: "whatever2",
        type: "source",
        subtypes: ["Anime", "Manga"],
        icon: "https://raw.githubusercontent.com/laynH/Anime-Girls-Holding-Programming-Books/master/C%2B%2B/Sakura_Nene_CPP.jpg",
    ...
    public static let sampleUpdate = Module(
        id: "whatever3",
        type: "source",
        subtypes: ["Comics"],
        icon: "https://raw.githubusercontent.com/laynH/Anime-Girls-Holding-Programming-Books/master/C%2B%2B/Sakura_Nene_CPP.jpg",
